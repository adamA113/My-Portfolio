...
const Header = () => {
    return (
        <header className="header">
            ...
            <img id="img_ID" className="map" src={header_img} alt="header-background" useMap="#header-img" />

            <map id="map_ID" name="header-img">
                <area alt="" title="" href="/" coords="523,52,561,52,561,108,559,172,557,249,552,308,552,346,552,398,553,449,553,504,554,554,551,605,498,607,425,607,339,608,233,606,140,605,122,586,125,529,126,482,129,402,128,326,133,306,117,228,102,157,89,82,88,55,197,50,349,51" shape="poly" />
            ...
            <div className="my-container">
                ...
                <p className="header-disc items-click" style={{ color: "#eb002f"}}>Click on the Image items</p>
            </div>
